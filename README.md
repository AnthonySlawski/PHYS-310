...
Lab Notebook 18: Introduction to Neural Networks
Objectives:
...
Lab Notebook 19: Particle ID Classification with Neural Networks
Objectives:
...
Lab Notebook 20: Photometric Redshift Estimation with Deep Neural Networks
Objectives:
...
Lab Notebook 21-22: Discovery of Exoplanets
Objectives:
...
Homework 1: Exploring Classifiers
Objectives:
...
Homework 3: Classification and Prediction in Astronomy
Objectives:
...
Homework 5: Learning the Ising Model Coupling Constants
Objectives:
To apply linear regression techniques to learn the coupling strengths 
�JKJJKKJKJJK
​
  of the one-dimensional Ising model, a fundamental model in statistical mechanics describing interactions between spins in a lattice.
...
Homework 6: Variance of Correlated Variables and Optimization of Extremely Random Trees
Objectives:
This homework involves two primary tasks: proving a formula related to the variance of a sum of correlated variables and optimizing the Extremely Random Tree algorithm for photometric redshift prediction.

Part 1: Variance Proof

Objective: Prove that the variance of a sum of correlated variables can be expressed in a specific form, highlighting the impact of correlation on variance.
Method: Utilized properties of covariance to derive the variance formula, considering both the correlation coefficient and the variance of individual variables.
Part 2: Algorithm Optimization

Objective: Optimize the Extremely Random Tree algorithm for predicting photometric redshifts, comparing its performance to the optimal Random Forest model.
Method: Employed grid search for hyperparameter optimization of the Extremely Random Tree model, assessing performance through metrics such as mean absolute error and outlier fraction.
Key Findings:
...
Homework 7: Hyperparameter Optimization with Keras Tuner
Objectives:
...
Homework 8: Hyperparameter Optimization with Keras Tuner and Cross-Validation with SciKeras
Objectives:
